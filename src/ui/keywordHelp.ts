...
export const KEYWORD_HELP: Record<string, string> = {
  ...
  伏せ場: 'コストを先に払ってカードを伏せておく場所（基本1枠）。敵の行動の実値を見てから発動するか温存するかを選ぶ。壊されると伏せた札は捨て札へ。1E払えば回収して手札に戻せる',
  伏せる: 'コストを払って手札の1枚を伏せ場に置く。伏せたターンだけ敵が気づいて動きを変えることがある（翌ターン以降の置きっぱなしは織り込み済み）。0Eで伏せた札や伏せ直しには敵は反応しない',
