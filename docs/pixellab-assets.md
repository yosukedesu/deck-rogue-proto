...
| カード枠（紙） | ui | 64×96 | 1種 | `card_paper.png`。クリーム色の紙＋鉛筆の二重線の9スライス（角12px）。**2026-09-07 の絵本調決定でタイプ×色の枠は廃止**——タイプは左上の「しおり」、色は台紙の縁で出す |
...
| カード挿絵 | cards | **80×48** | 412（最後） | `card_<id>.png`。**2倍で 160×96、紙の台紙（168×104）に貼る**。絵が無い札はタイプの紋章 16×16 を3倍 |
