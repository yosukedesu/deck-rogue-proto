...
| 種別 | 状態 |
|---|---|
| 敵 | **84/85**（幕1〜3・エリート・ボス。2026-09-11 に幕2/3の59体を追加、向きを検算済み）。**未作成1: 苔の産み手**（2026-09-14 召喚者。幕2・獣系「苔の塊」。`docs/pixellab/enemy-kinds.json` に追加済み・プレースホルダーで動く） |
...
| レリック本家形の第1波（2026-09-12） | 新レリック **63/63**（在庫102に追随。発注書 `docs/pixellab/relics-2026-09-12.json`・説明 `relics-2026-09-12-descriptions.json`。2シード→シート6枚→判定→`art-b7d18.py apply`。B7–D18 と同じ「ancient mine relic・単一の物・人型なし」の定型） |
...
| # | 種別 | 置き場・名前 | 実寸 | 枚数 | 備考 |
|---|---|---|---|---|---|
| 7 | レリック | `Art/relics/<id>.png` | 32×32 | ~~39~~ **済 102/102** | 2026-09-11 一括作成39＋2026-09-12 本家形の第1波63 |
